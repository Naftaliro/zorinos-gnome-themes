# Orchis (Material Design) Theme: Full Installation Guide
...
This guide provides a comprehensive overview and step-by-step installation for the **Orchis** theme suite, a polished and modern Material Design theme for GNOME created by Vince Liuice [1]. The included script automates the entire process, giving you a complete, system-wide dark theme with a purple accent.
...
|---|---|---|---|
| **GTK Theme** | Orchis | `Orchis-purple-Dark` | [vinceliuice/Orchis-theme][1] |
| **GNOME Shell** | Orchis | `Orchis-purple-Dark` | [vinceliuice/Orchis-theme][1] |
...
| **Libadwaita** | Orchis | Overridden for GTK4 apps | [vinceliuice/Orchis-theme][1] |
| **Flatpak** | Orchis | Filesystem override | N/A |

This combination results in a visually consistent and modern desktop, from the login screen to the application windows.
...
You can easily customize the theme by editing the configuration variables at the top of the `orchis-theme-install.sh` script before running it.
...
For example, to install a light theme with a blue accent, you would change `ACCENT` to `"blue"` and `COLOR` to `"light"`.
...
#
# Usage:
#   chmod +x orchis-theme-install.sh && ./orchis-theme-install.sh
# ──────────────────────────────────────────────────────────────────────────────
...
[1] vinceliuice, *Orchis GTK Theme*, GitHub Repository, [https://github.com/vinceliuice/Orchis-theme](https://github.com/vinceliuice/Orchis-theme)
