# Graphite (Minimalist Dark) Theme: Full Installation Guide
...
This guide provides a comprehensive overview and step-by-step installation for the **Graphite** theme suite, a sleek, modern, and minimalist dark theme for GNOME created by Vince Liuice [1]. The included script automates the entire process, giving you a complete, system-wide dark theme with a purple accent and GDM (login screen) support.
...
|---|---|---|---|
| **GTK Theme** | Graphite | `Graphite-purple-Dark` | [vinceliuice/Graphite-gtk-theme][1] |
| **GNOME Shell** | Graphite | `Graphite-purple-Dark` | [vinceliuice/Graphite-gtk-theme][1] |
| **GDM Theme** | Graphite | `Graphite-purple-Dark` | [vinceliuice/Graphite-gtk-theme][1] |
...
| **Libadwaita** | Graphite | Overridden for GTK4 apps | [vinceliuice/Graphite-gtk-theme][1] |
| **Flatpak** | Graphite | Filesystem override | N/A |

This combination results in a visually consistent and minimalist desktop, from the login screen to the application windows.
...
2.  **Make the script executable:**
    ```bash
    chmod +x graphite-theme-install.sh
    ```

3.  **Run the installer:**
    ```bash
    ./graphite-theme-install.sh
    ```

## Post-Installation

After the script finishes, you **must log out and log back in** for all changes to take effect, especially for the GNOME Shell and GDM (login screen) themes.
...
You can easily customize the theme by editing the configuration variables at the top of the `graphite-theme-install.sh` script before running it.
...
For example, to install a light theme with a blue accent and without the GDM theme, you would change `ACCENT` to `"blue"`, `COLOR` to `"light"`, and `INSTALL_GDM` to `"no"`.
...
[1] vinceliuice, *Graphite GTK Theme*, GitHub Repository, [https://github.com/vinceliuice/Graphite-gtk-theme](https://github.com/vinceliuice/Graphite-gtk-theme)
